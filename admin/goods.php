...
require_once(ROOT_PATH . '/' . ADMIN_PATH. "/nusoap/nusoap.php");   //代码增加  By  www.cfweb2015.com
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
	...
	// 代码增加_start_derek20150129admin_goods  www.cfweb2015.com

	include_once(ROOT_PATH . '/includes/Pinyin.php');

	// 代码增加_end_derek20150129admin_goods  www.cfweb2015.com
    ...
    if ($is_add)
    {
        ...
        $goods = array(
            ...
            'warn_number'   => 1,
            /* 代码修改 By  www.cfweb2015.com 促销商品时间精确到时分 Start */
...
//            'promote_end_date'   => local_date('Y-m-d', local_strtotime('+1 month')),
            ...
            /* 代码修改 By  www.cfweb2015.com 促销商品时间精确到时分 End */
...
//            $goods['promote_end_date'] = local_date('Y-m-d', $goods['promote_end_date']);
    ...
    /* 创建 html editor */
    create_html_editor('goods_desc', htmlspecialchars($goods['goods_desc'])); /* 修改 by www.cfweb2015.com 百度编辑器 */
