...
//$modules['02_cat_and_goods']['14_goods_export'] = 'goods_export.php?act=goods_export'; //批量导出
...
//$modules['04_order']['10_back_order'] = 'back.php?act=back_list'; //退款/退货/维修
                                                                                // By
                                                                                // www.cfweb2015.com
//$modules['04_order']['11_supplier_back_order'] = 'back.php?act=back_list&supp=1'; // 代码修改 入驻商退换货
                                                                                       // By
                                                                                       // www.cfweb2015.com
                                                                                       // ecshop
                                                                                       // add
...
//$modules['04_order']['11_kuaidi_order'] = 'kuaidi_order.php?act=list'; //快递单
...
/* 虚拟卷订单列表_添加_START_www.cfweb2015.com */
...
/* 代码添加_START By www.cfweb2015.com */
$modules['06_stats']['keyword'] = 'keyword.php?act=list'; // 客户搜索记录
/* 代码添加_SEND By www.cfweb2015.com */
...
//隐藏 0114
//$modules['07_content']['vote_list'] = 'vote.php?act=list'; //在线调查
//隐藏 0114
...
//隐藏0114
//$modules['11_system']['file_check'] = 'filecheck.php'; //文件坚持
...
//隐藏0114
//$modules['13_backup']['04_sql_query'] = 'sql.php?act=main'; //sql查询
...
//$modules['16_email_manage']['view_sendlist'] = 'view_sendlist.php?act=list'; //邮件队列管理
...
/* 代码增加_start By www.cfweb2015.com */
//$modules['03_promotion']['16_takegoods_list'] = 'takegoods.php?act=list'; //提货券
//$modules['03_promotion']['16_takegoods_order'] = 'takegoods.php?act=order_list';//提货券提货列表
/* 代码增加_end By www.cfweb2015.com */
//$modules['16_email_manage']['sendmail'] = 'sendmail.php?act=sendmail'; //发送邮件
/* 代码增加_start By www.cfweb2015.com */
//hide by ran//$modules['02_cat_and_goods']['pricecut'] = 'pricecut.php?act=list&status=-1';
...
/* 代码增加_start By www.cfweb2015.com */
//$modules['03_promotion']['19_valuecard_list'] = 'valuecard.php?act=list';//储值卡管理
