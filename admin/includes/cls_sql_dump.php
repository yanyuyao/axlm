...
function dump_escape_string($str)
{
	...
	/* 代码修改_star  By  www.cfweb2015.com */
}
...
class cls_sql_dump
{
     ...
     */
    public static function get_head($path)  //代码修改   By    www.cfweb2015.com   增加 public static
    {
        /* 获取sql文件头部信息 */
     ...
     */
    public static function get_random_name()  //代码修改   By    www.cfweb2015.com
    {
        $str = date('Ymd');
