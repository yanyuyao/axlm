            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDemail" value="beijingpinrui@126.com" />
                        <span>必填</span>
                    </dd>
                    <dt>付款账户名：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDaccount_name" value="北京品瑞珠宝有限责任公司"/>
                        <span>必填，个人支付宝账号是真实姓名公司支付宝账号是公司名称</span>
                    </dd>
                    <dt>付款当天日期：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDpay_date" value="20170118" />
                        <span>必填，格式：年[4位]月[2位]日[2位]，如：20100801</span>
                    </dd>
                    <dt>批次号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_no" value="20170118000001" />
                        <span>必填，格式：当天日期[8位]+序列号[3至16位]，如：201008010000001</span>
                    </dd>
                    <dt>付款总金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbatch_fee" value="0.1"/>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDdetail_data" value="2017011851825^qinghaiyiyi^王冉冉"/>
