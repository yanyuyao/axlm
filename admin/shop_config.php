...
$auth = local_mktime(); //代码修改  By www.cfweb2015.com
$ac = md5($certi_id.'SHOPEX_SMS'.$auth);
$url = 'http://cfweb2015.com/sms/index.php?certificate_id='.$certi_id.'&sess_id='.$sess_id.'&auth='.$auth.'&ac='.$ac;
        ...
        if ((isset($file['error']) && $file['error'] == 0) || (!isset($file['error']) && $file['tmp_name'] != 'none'))
        {
            ...
            else
            {
                ...
                else
                {
              	...
              	/*生成商品默认图片缩略图  修改 start by www.cfweb2015.com */
