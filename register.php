...
//echo "<br>===========================<br>";
//save_expend_fenxiao_userinfo('tyt',9996);
//echo "<br>===========================<br>";
/* 如果是显示页面，对页面进行相应赋值 */
if(true)
{
	...
	$smarty->assign('is_need_yanzhengma', $GLOBALS['is_need_yanzhengma']);
}
...
function action_default ()
{
	...
	/* 代码增加_star By www.cfweb2015.com */
	$smarty->assign('sms_register', $_CFG['sms_register']);
	/* 代码增加_end By www.cfweb2015.com */
	/* 增加是否关闭注册 */
