								...
								<table width="400" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_32389300_1490068281');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_32389300_1490068281']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_32389300_1490068281']['name_p'] >= "a" && $this->_var['brand_list_0_32389300_1490068281']['name_p'] <= "g"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_32389300_1490068281']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_32389300_1490068281']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_32389300_1490068281']['name']; ?>')"><?php echo $this->_var['brand_list_0_32389300_1490068281']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_32410000_1490068281');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_32410000_1490068281']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_32410000_1490068281']['name_p'] >= "h" && $this->_var['brand_list_0_32410000_1490068281']['name_p'] <= "k"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_32410000_1490068281']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_32410000_1490068281']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_32410000_1490068281']['name']; ?>')"><?php echo $this->_var['brand_list_0_32410000_1490068281']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_32429500_1490068281');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_32429500_1490068281']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_32429500_1490068281']['name_p'] >= "l" && $this->_var['brand_list_0_32429500_1490068281']['name_p'] <= "s"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_32429500_1490068281']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_32429500_1490068281']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_32429500_1490068281']['name']; ?>')"><?php echo $this->_var['brand_list_0_32429500_1490068281']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_32448600_1490068281');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_32448600_1490068281']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_32448600_1490068281']['name_p'] >= "t" && $this->_var['brand_list_0_32448600_1490068281']['name_p'] <= "z"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_32448600_1490068281']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_32448600_1490068281']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_32448600_1490068281']['name']; ?>')"><?php echo $this->_var['brand_list_0_32448600_1490068281']['name']; ?></a>
												</div>
											</div>
										...
										<td valign="top" style="padding-left:10px">
											<!-- <?php $_from = $this->_var['brand_list_new']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_32472100_1490068281');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_32472100_1490068281']):
?> -->
											<!-- <?php if ($this->_var['brand_list_0_32472100_1490068281']['name_p'] >= "0" && $this->_var['brand_list_0_32472100_1490068281']['name_p'] <= "9"): ?> -->

											<div id="@<?php echo $this->_var['key']; ?>">
												<div id="<?php echo $this->_var['brand_list_0_32472100_1490068281']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_32472100_1490068281']['name']; ?>">
													<a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_32472100_1490068281']['name']; ?>')"><?php echo $this->_var['brand_list_0_32472100_1490068281']['name']; ?></a>
												</div>
											</div>
...
?>
				...
				<tr style="display:none;">
					...
					<td>
						...
						<input type="text" name="give_integral" value="0" size="20" />
						<br />
				...
				<tr style="display:none;">
					...
					<td>
						<input type="text" name="rank_integral" value="0" size="20" />
						<br />
