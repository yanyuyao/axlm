...
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/css/flow.css" />
...
?>
        <li>
          ...
          <p class="name"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" ><?php echo $this->_var['goods']['short_goods_name']; ?></a></p>
      ...
      <div class="timebox">
        <ul>
          <li class="curr" id="time_id_1" onClick="javascript:setTimeSh('1');">
            <input id="time_delivery1" type="radio" name="best_time" value="<?php echo $this->_var['lang']['working_day_delivery']; ?>" checked=checked>
            <label for="time_delivery1"><?php echo $this->_var['lang']['working_day_delivery']; ?></label>
          </li>
          <li id="time_id_2" onClick="javascript:setTimeSh('2');">
            <input id="time_delivery2" type="radio" name="best_time" value="<?php echo $this->_var['lang']['weekend_delivery']; ?>" >
            <label for="time_delivery2"><?php echo $this->_var['lang']['weekend_delivery']; ?></label>
          </li>
          <li id="time_id_3" onClick="javascript:setTimeSh('3')" >
            <input id="time_delivery3" type="radio" name="best_time" value="<?php echo $this->_var['lang']['all_delivery']; ?>" >
            <label for="time_delivery3"><?php echo $this->_var['lang']['all_delivery']; ?></label>
          </li>
          <li id="time_id_4" style="position:relative;" onmouseover="if(this.className=='curr' || this.className=='curr2'){this.className='curr';}else{this.className='cur2';}"  onmouseout="if(this.className=='curr'){this.className='curr2';}else{this.className='cur';}" onClick="javascript:setTimeSh('4')" >
            ...
            <label for="definetime_input" id="definetime"><?php echo $this->_var['lang']['specified_delivery_time']; ?></label>
...
?>
                  <td align=center><span><?php echo $this->_var['week']['name']; ?><br/><?php echo $this->_var['week']['week']; ?></span></td>
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </tr>
                <tr bgcolor=#ffffff>
...
?>
        <tr>
          <td colspan=4 style="background:#FAFAFA; border-top:1px solid #eee; font-weight:bold; padding:5px 10px;" > <?php echo $this->_var['goodsinfo']['goodlist']['0']['seller']; ?></td>
        </tr>
        ...
        <tr>
          <td width='50%' <?php if (($this->_foreach['name']['iteration'] <= 1)): ?>style="border-top:none;"<?php endif; ?>><?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
            ...
            <div class="thumb_name">
              <dl >
                <dt> <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" style="border:1px solid #eeeeee;" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a> </dt>
...
?>
                        <tr >
                          ...
                          <td <?php if (! ($this->_foreach['package_goods_list']['iteration'] == $this->_foreach['package_goods_list']['total'])): ?>style="border-bottom:1px dashed #bbb;"<?php endif; ?>><div style="float:left;border:1px solid #bbb;background:#eeeeee;width:20px;text-align:center;padding:5px 10px;"><?php echo $this->_var['package_goods_list']['goods_number']; ?></div></td>
...
?>
                  ...
                  <td>&nbsp; 或 &nbsp;<a href="javascript:void(0);" onclick="javascript:document.getElementById('Bonus_span_<?php echo $this->_var['key']; ?>').style.display='block';document.getElementById('Bonus_a_<?php echo $this->_var['key']; ?>').style.display='none';" class="main-color" id="Bonus_a_<?php echo $this->_var['key']; ?>">直接输入优惠券号</a></td>
                ...
                <table class="subbox_other" width="100%">
                  ...
                  <tbody width="100%" cellpadding="5" cellspacing="0">
                    <tr>
                      ...
                      <td align=left colspan="2"><select name="inv_type" id="ECS_INVTYPE" <?php if ($this->_var['order']['need_inv'] != 1): ?>disabled="true"<?php endif; ?> onchange="changeNeedInv()" class="select fl">
...
<?php echo $this->html_options(array('options'=>$this->_var['inv_type_list'],'selected'=>$this->_var['order']['inv_type'])); ?>
                        ...
                        &nbsp;&nbsp;
                        <select name="inv_content" id="ECS_INVCONTENT" <?php if ($this->_var['order']['need_inv'] != 1): ?>disabled="true"<?php endif; ?>  onchange="changeNeedInv()" class="select fl">
...
?>
		...
		<!--
			<tr>
            <td colspan=4 class="tdother2"><div class="checkout_other" > <a class="jmbag" href="javascript:void(0);" onclick="showCheckoutOther(this);"><span>+</span>订单留言</a>
                <table class="subbox_other" width="100%">
                  <tbody width="100%" cellpadding="5" cellspacing="0">
                    <tr>
                      <td align=right width="100" valign=top>订单留言：</td>
                      <td colspan='4'><textarea name="postscript" cols="80" rows="3" id="postscript" class="textarea"><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></textarea></td>
                    </tr>
                  </tbody>
                </table>
              </div></td>
          ...
          <tr>
            <td colspan=4 class="tdother2">
            	<div class="allow_user_surplus">
					...
					<input name="surplus" type="text" class="surplus" id="ECS_SURPLUS"  value="0" onblur="changeSurplus(this.value);" />&nbsp;&nbsp;元</span>
...
?> 
              ...
              <li>
              	<label for="payment_other<?php echo $this->_foreach['payment_list']['iteration']; ?>">
                    <input id="payment_other<?php echo $this->_foreach['payment_list']['iteration']; ?>" type="radio" name="payment_other" onclick="selectPayment(this);document.getElementById('payment_other_input').value=this.value;" value="<?php echo $this->_var['payment']['pay_id']; ?>" >
                    <img align="absmiddle" src="themes/68ecshopcom_360buy/images/jmpic/pay_<?php echo $this->_var['payment']['pay_code']; ?>.gif" alt="<?php echo $this->_var['payment']['pay_name']; ?>" />
                </label>
              </li>
              <?php endif; ?> 
              <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <div class="flowBox_jm clearfix" style="border:none;padding-bottom:20px;">
      ...
      <?php if (! $this->_var['one_step_buy']): ?><a href="flow.php" class="continue_buy" style="padding:0;">返回修改购物车</a><?php endif; ?> </div>
      <div style="float:right;width:55%;text-align:right;padding:8px 20px;"> 
        
        <input onclick="return check_before_submit()" type="image" src="themes/68ecshopcom_360buy/images/jmpic/btn_done.png" align="absmiddle" />
  ...
  <div class="flowBox" style="margin:30px auto 70px auto;">
    ...
    <table width="99%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" style="border:1px solid #eeeeee; margin:20px auto;" >
      <tr>
